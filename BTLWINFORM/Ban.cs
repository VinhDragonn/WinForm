    ...
    public partial class Ban : Form
    {
        ...
        public Ban(string tenNguoi, string quyen)
        {
            ...
            tabControl1.SelectedIndexChanged += (s, e) =>
            {
                ...
                else if (tabControl1.SelectedTab == tabPage4 || tabControl1.SelectedTab == tabPage3 || tabControl1.SelectedTab == tabPage2)
                {
        ...
        private void buttonTT_Click(object sender, EventArgs e)
        {
                ...
                if (a == "Có người")
                {
                    ...
                    QL.ThanhToanTableList(IDban);
                    QL.DELETE_ALL_HOA_DON(IDban);
                    
                    string chuoiMonAn = string.Join(", ", listMonAn);

                    QL.INSERT_HOADON_THANH_TOAN(IDban, newDn.TenNguoi, chuoiMonAn,TenKH, TimeNow, tong);
